        ...
        <div class="card profile custom-font">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control" value="Budi" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="telephone" name="telephone" class="form-control" value="+62 812 3456 7890" readonly>
                </div>
                <div class="form-group">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" id="email" name="email" class="form-control" value="budi@example.com" readonly>
                </div>
                <a href="<?= site_url('profile/edit'); ?>" class="btn btn-primary custom-btn">Edit Profile</a>
            </div>
        </div>
    </div>
</body>
